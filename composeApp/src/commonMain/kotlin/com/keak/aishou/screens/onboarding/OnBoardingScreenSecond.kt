...
import aishou.composeapp.generated.resources.happy
import aishou.composeapp.generated.resources.onboarding_are_you_bored
import aishou.composeapp.generated.resources.onboarding_find_your_real_tribe
import aishou.composeapp.generated.resources.onboarding_real_talk
import aishou.composeapp.generated.resources.onboarding_second_solution
import aishou.composeapp.generated.resources.onboarding_sounds_amazing
import aishou.composeapp.generated.resources.onboarding_tired_of_fake_friend
import aishou.composeapp.generated.resources.onboarding_want_friends
import aishou.composeapp.generated.resources.onboarding_what_if
    ...
    Column(
        modifier = Modifier.fillMaxSize().background(
            brush = Brush.verticalGradient(
                colors = listOf(
                    Color(0xFF81C784), // Deep dark blue-black
                    Color(0xFF64B5F6), // Dark purple-black
                    Color(0xFFBA68C8), // Midnight blue
                )
            )
        ),
        ...
        NeoBrutalistCardViewWithFlexSize(
            ...
            Column(
                ...
                NeoBrutalistCardViewWithFlexSize(
                    ...
                    backgroundColor = Color(0xFF66BB6A), // Dark red, more ominous
                ) {
                    Text(
                        text = stringResource(Res.string.onboarding_second_solution),
                        color = Color.White,
                ...
                Text(
                    text = stringResource(Res.string.onboarding_find_your_real_tribe),
                    color = Color.Black,
                    fontWeight = FontWeight.Black,
                    fontSize = 22.sp,
                ...
                Spacer(Modifier.height(8.dp))
                Text(
                    text = stringResource(Res.string.onboarding_what_if),
                    color = Color.Black,
        ...
        BrokenTVText(
            text = stringResource(Res.string.onboarding_want_friends),
            modifier = Modifier.fillMaxWidth(),
            fontSize = 22.sp,
            fontWeight = FontWeight.Black,
            color = Color.White
        ...
        NeoBrutalistCardViewWithFlexSize(
            modifier = Modifier.width(desiredWidth.dp).clickable(role = Role.Button){
                router.goToOnBoardingThird()
            },
            backgroundColor = Color.White, // Dark gray/black
            borderColor = Color(0xFF424242), // Medium dark gray border
            cornerRadius = 16.dp
        ){
            Text(
                text = stringResource(Res.string.onboarding_sounds_amazing),
                color = Color.Black, // White text on dark background
                fontWeight = FontWeight.Black,
                fontSize = 14.sp
            )
        }
